...
import com.vinamrasareen.comaniacs.bakingApp.pojo.Step;
...
import static com.vinamrasareen.comaniacs.bakingApp.ui.RecipeActivity.SELECTED_INDEX;
import static com.vinamrasareen.comaniacs.bakingApp.ui.RecipeActivity.SELECTED_RECIPES;
import static com.vinamrasareen.comaniacs.bakingApp.ui.RecipeActivity.SELECTED_STEPS;
   ...
   private ListItemClickListener itemClickListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (!videoURL.isEmpty()) {
            ...
            player.setPlayWhenReady(videoState);
    ...
    public void onSaveInstanceState(Bundle currentState) {
        ...
        currentState.putLong("VP", videoPosition);
        currentState.putBoolean("VS", videoState);
    }
    ...
    public void onPause() {
        ...
        if (player!=null) {
            ...
            videoState = player.getPlayWhenReady();
        }
        releasePlayer();
    }
